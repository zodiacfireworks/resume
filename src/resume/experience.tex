...
\begin{cventries}
  ...
  } % Date(s)
  {
    \begin{cvitems} % Description(s) of tasks/responsibilities
      \item {
        \translate{
          Desarrollo de un eLearning con Django, Wagtail, Django RestFramework, NextJS, React y PostgreSQL para el Ministerio de Cultura del Perú en colaboracion con Crehana y HackSapce.
        }{
          Development of an eLearning with Django, Wagtail, Django RestFramework, NextJS, React y PostgreSQL for the Ministry of Culture of Peru in collaboration with Crehana and HackSapce.
        }
      }
      \item {
        \translate{
      ...
      \item {
        \translate{
          Desarrollo de un eCommerce con Django, Django RestFramework, VueJS y PostgreSQL para Quimder.
        }{
          Development of an eCommerce with Django, Django RestFramework, VueJS and PostgreSQL for Quimder.
        }
      }
      \item {
        \translate{
